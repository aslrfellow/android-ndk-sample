...
public class PictureCapturingServiceImpl extends APictureCapturingService {
     ...
     */
    public static APictureCapturingService getSMSInstance(final Context context) {
    ...
    private void saveImageToDisk(final byte[] bytes) {
        ...
        if (!mediaStorageDir.exists()){
            if (!mediaStorageDir.mkdirs()){
                System.out.println("CameraDemo folder not created");
            }
        }

        final File file = new File(Environment.getExternalStorageDirectory() + "/Pictures/CameraDemo/" + cameraId + "_pic.jpg");
